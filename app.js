    ...
    async (
      ...
      if (
        ...
        try {
          ...
          console.error(
            "refresh finance after purchase receipt failed:",
            error
          );

          openDeleteModal(
            "Поставку прийнято, але сторінку не вдалося оновити. Оновіть фінансовий розділ вручну.",
            null,
            "operation-success"
          );
        }
...
function applyFinancePurchaseReceipt(
  purchase,
  receivedItems,
  result = {}
) {
